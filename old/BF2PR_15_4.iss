...
Filename: {group}\Ссылки\Перейти на форум BF2.GameRing.RU.url; Section: InternetShortcut; Key: URL; String: http://bf2.gamering.ru/forum
Filename: {group}\Ссылки\Перейти на сайт PR.GameRing.RU.url; Section: InternetShortcut; Key: URL; String: http://pr.gamering.ru
Filename: {group}\Ссылки\Перейти на форум PR.GameRing.RU.url; Section: InternetShortcut; Key: URL; String: http://pr.gamering.ru/forum
