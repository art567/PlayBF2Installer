...
Name: {group}\Battlefield 2 - Window mode; Filename: {app}\BF2.exe; Parameters: +menu 1 +fullscreen 0 +szx 800 +szy 600 +wx 20 +wy 20; WorkingDir: {app}; IconFilename: {app}\BF2.exe; Comment: Launch Battlefield 2 in windowed mode; IconIndex: 0; Languages: English
Name: {group}\Battlefield 2 - Connect to GameRing.ru; Filename: {app}\BF2.exe; Parameters: +menu 1 +fullscreen 1 +restart 1 +joinServer bf2.gamering.ru +port 16567; WorkingDir: {app}; IconFilename: {app}\BF2.exe; Comment: Launch Battlefield 2 and connect to GameRing.ru; IconIndex: 0; Languages: English
...
Name: {group}\Project Reality - Connect to GameRing.ru; Filename: {app}\mods\pr\pr.exe pr://pr.gamering.ru:16570; WorkingDir: {app}\mods\pr; IconFilename: {app}\mods\pr\pr.exe; Comment: Launch Project Reality: Battlefield 2 and connect to GameRing.ru; IconIndex: 0; Languages: English
...
Name: {group}\Battlefield 2 - Запуск в оконном режиме; Filename: {app}\BF2.exe; Parameters: +menu 1 +fullscreen 0 +szx 800 +szy 600 +wx 20 +wy 20; WorkingDir: {app}; IconFilename: {app}\BF2.exe; Comment: Запустить Battlefield 2 в режиме окна; IconIndex: 0; Languages: Russian
Name: {group}\Battlefield 2 - Подключиться к GameRing.ru; Filename: {app}\BF2.exe; Parameters: +menu 1 +fullscreen 1 +restart 1 +joinServer bf2.gamering.ru +port 16567; WorkingDir: {app}; IconFilename: {app}\BF2.exe; Comment: Запустить Battlefield 2 и подключиться к серверу GameRing.ru; IconIndex: 0; Languages: Russian
;Name: {group}\Battlefield 2 - Подключиться к GameRing.ru; Filename: {app}\BF2.exe; Parameters: +menu 1 +fullscreen 1 +restart 1 +playerPrefix ваш_префикс +playerName ваш_ник +playerPassword ваш_пароль +joinServer bf2.gamering.ru +port 16567; WorkingDir: {app}; IconFilename: {app}\BF2.exe; Comment: Запустить Battlefield 2 и подключиться к серверу GameRing.ru; IconIndex: 0; Languages: "Russian"
...
Name: {group}\Project Reality - Подключиться к GameRing.ru; Filename: {app}\mods\pr\pr.exe pr://pr.gamering.ru:16570; WorkingDir: {app}\mods\pr; IconFilename: {app}\mods\pr\pr.exe; Comment: Запустить Project Reality: Battlefield 2 и подключиться к серверу GameRing.ru; IconIndex: 0; Languages: Russian
;Name: {group}\Project Reality - Подключиться к GameRing.ru; Filename: {app}\mods\pr\pr.exe pr://pr.gamering.ru:16570; WorkingDir: {app}\mods\pr; IconFilename: {app}\mods\pr\pr.exe; Comment: Запустить Project Reality: Battlefield 2 и подключиться к серверу GameRing.ru; IconIndex: 0; Languages: "Russian"
...
[INI]
; English
Filename: {group}\Links\Visit our website bf2.gamering.ru.url; Section: InternetShortcut; Key: URL; String: http://bf2.gamering.ru; Languages: English
Filename: {group}\Links\Visit forums on bf2.gamering.ru.url; Section: InternetShortcut; Key: URL; String: http://bf2.gamering.ru/forum; Languages: English
Filename: {group}\Links\Visit our website pr.gamering.ru.url; Section: InternetShortcut; Key: URL; String: http://pr.gamering.ru; Languages: English
Filename: {group}\Links\Visit forums on pr.gamering.ru.url; Section: InternetShortcut; Key: URL; String: http://pr.gamering.ru/forum; Languages: English
...
; Russian
Filename: {group}\Ссылки\Перейти на сайт bf2.gamering.ru.url; Section: InternetShortcut; Key: URL; String: http://bf2.gamering.ru; Languages: Russian
Filename: {group}\Ссылки\Перейти на форум bf2.gamering.ru.url; Section: InternetShortcut; Key: URL; String: http://bf2.gamering.ru/forum; Languages: Russian
Filename: {group}\Ссылки\Перейти на сайт pr.gamering.ru.url; Section: InternetShortcut; Key: URL; String: http://pr.gamering.ru; Languages: Russian
Filename: {group}\Ссылки\Перейти на форум pr.gamering.ru.url; Section: InternetShortcut; Key: URL; String: http://pr.gamering.ru/forum; Languages: Russian
