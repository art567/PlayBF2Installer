...
Filename: "msiexec"; Parameters: "/i {app}\Redist\PR_Mumble.msi"; WorkingDir: {app}\Redist\; Flags: waituntilidle skipifdoesntexist postinstall runascurrentuser; Description: Установить PR Mumble 1.0
