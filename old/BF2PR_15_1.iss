...
WizardImageFile=Graphic\BF2.bmp
SetupIconFile=Graphic\BF2.ico
...
OutputDir=C:\BF2Installer
OutputBaseFilename=bf2setup
...
Name: {group}\Project Reality; Filename: {app}\mods\pr\pr.exe; WorkingDir: {app}\mods\pr; IconFilename: {app}\mods\pr\pr.exe; Comment: Запустить Project Reality: BattleField 2; IconIndex: 0; Languages: 
...
Name: {userdesktop}\Battlefield 2; Filename: {app}\BF2.exe; Parameters: +menu 1 +fullscreen 1 +restart 1; WorkingDir: {app}; IconFilename: {app}\BF2.exe; Comment: Запустить Battlefield 2
Name: {userdesktop}\Battlefield 2 - Special Forces; Filename: {app}\BF2.exe; Parameters: +menu 1 +fullscreen 1 +restart 1 +modPath mods/xpack +ignoreAsserts 1; WorkingDir: {app}; IconFilename: {app}\mods\xpack\bf2xpack.ico; Comment: Запустить Battlefield 2 - Special Forces
Name: {userdesktop}\Battlefield 2; Filename: {app}\BF2.exe; Parameters: +menu 1 +fullscreen 1 +restart 1; WorkingDir: {app}; IconFilename: {app}\BF2.exe; Comment: Запустить Battlefield 2
[UninstallDelete]
...
Filename: {group}\Ссылки\Перейти на форум BF2.GameRing.RU.url; Section: InternetShortcut; Key: URL; String: http://forum.mediaring.ru/?t=thread&frm_id=72
